...
const heroes = [
  {
    ...
    sub: "Grow real, engaged audiences",
  },
  {
    img: facebook,
    title: "Facebook Advertising",
    sub: "Pages & posts that convert",
  },
  ...
  { img: website, title: "Web Development", sub: "Fast, modern, responsive" },
  {
    ...
    sub: "Everything from the ground up",
  },
];
  ...
  <div>
    ...
    <div style={{ textAlign: "center", marginBottom: 28 }}>
      <Tag
        ...
        color="processing"
        style={{ borderRadius: 999, padding: "2px 14px" }}
      >
        Service Center
      </Tag>
      <Title
          ...
          >
            ...
            >
              <Space align="center" size={8}>
                <PlayCircleOutlined
                  style={{ color: "#818CF8", fontSize: 20 }}
                />
                <Text
                  style={{
                    color: "#C7D2FE",
